...
\supervisor{Dr. John Shawe \textsc{Taylor} \newline $\&$ Christopher \textsc{Grainger} } % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
%\supervisor{Christopher Grainger}
...
\department{\href{http://www.cs.ucl.ac.uk/degrees/msc_ml/}{UCL Dept. of Computer Science}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
\faculty{\href{http://www0.cs.ucl.ac.uk/staff/J.Shawe-Taylor/}{Dr. John Shawe Taylor}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
% stuff for drawing graphical models
\usepackage{tikz}
...
\emph{Author:}\\
\href{https://www.linkedin.com/profile/preview?vpa=pub&locale=en_US}{\authorname} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
\begin{flushright} \large
\emph{Supervisors:} \\
\href{http://www0.cs.ucl.ac.uk/staff/J.Shawe-Taylor/}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
...
\large \textit{This thesis is submitted in fulfillment of the requirements\\ for the degree of \degreename}\\[0.3cm] % University requirement text
%\textit{in the}\\[0.4cm]
\groupname\\
\deptname\\[2cm] % Research group name and department name
 
 \large \textit{It is substantially the result of my own work except where explicitly indicated in the text. The report may be freely copied and distributed provided the source is explicitly acknowledged.}\\[0.3cm] 
...
%, and provide a window into the progression of that change.
%and provide a method for revealing the underlying semantic structure of a document collection.

%approximate posterior inference over topics
